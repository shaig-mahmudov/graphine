...
for fixture in java-core java-unresolved; do
  ...
  python3 -c 'import json,sys; print(json.dumps({"protocol_version":2,"request_id":"accuracy-"+sys.argv[2],"operation":"analyze_project","language":"java","project_root":sys.argv[1],"mode":"safe","source_sets":["main","test"],"options":{"include_method_bodies":True,"include_field_access":True,"include_tests":True,"explicit_classpath":[]},"maven_executable":"mvn","cargo_executable":"cargo","rustc_executable":"rustc","cargo":{},"timeout_ms":120000}))' "$project" "$fixture" \
